...
import { View, Text, TouchableWithoutFeedback,TouchableOpacity, TouchableHighlight } from 'react-native';
        ...
        return(
            ...
            <View style= {{ backgroundColor: '#2e2e2e',}}>
                ...
                <View style = { containerStyle }>
                    <TouchableWithoutFeedback onPress= {() => this.changeSelectedTo(0)}>
                    ...
                    <TouchableWithoutFeedback onPress= {() => this.changeSelectedTo(1)}>
                        <View style = { buttonStyle }>
                    ...
                    <TouchableWithoutFeedback onPress= {() =>this.changeSelectedTo(2)}>
                        <View style = { buttonStyle }>
                    ...
                    <TouchableWithoutFeedback onPress= {() => this.changeSelectedTo(3)}>
                        <View style = { buttonStyle }>
            ...
            <TouchableHighlight onPress= {() => this.createPost()} style = {{position:'absolute', alignSelf: 'center', flex: 1, top: '-30%'}} underlayColor= 'rgba(0,0,0, 0.2)' >
            <View style ={{backgroundColor='#727272', borderRadius: 50}}>
